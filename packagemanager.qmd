...
In a nutshell, when wanting to **install libraries**, you can just do it through your console and l**ibraries are fetch through package manager** from **cran, pyp, bioconductor even from Github !!**, without needing to go through individual repository on internet. All in one package!
