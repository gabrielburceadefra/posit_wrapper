...
## RStudio on Workbench

1.  Login into Dash Workbench - to be provided mid-end of October
...
knitr::include_graphics("images/databricks_connection_4.png")
```
...
1.  Go to **Settings** -\> **Remote\[dash-workbench-prd-azure.defra.cloud\]**
2.  Search for **SSL**
3.  Choose **Application** -\> **Proxy** and un-thick the box for **Http: Proxy Strict SSL.**

```{r  echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_extensions.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_extensions_installing_sql.png")
```
...
1.  Go to Explorer -\> Clone Repository

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_1.png") 
```

2.  Press Allow

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_2.png")
```

3.  A code to Copy will show up -\> Copy and Continue to Github

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_3.png")
```

4.  You have to be logged into Github first. Press Open.

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_4.png")
```

5.  Copy the one time code to paste into next window

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_5.png")
```
...
knitr::include_graphics("images/vs_code_git_6.png")
```

7.  Scroll down and Authorise Visual Code

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_7.png")
```

8.  Now go back to Visual Code and you should be able to see all the repositories you own on Github.

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("images/vs_code_git_8.png")
```
...
Package manager provides a secure, reliable, and scalable way to distribute and manage Python packages across Dash. Check the Package Manager section for more information. Check the section within Dash Playbook bellow or navigate to [Dash Package Manager](https://dash-pkmgr-prd.azure.defra.cloud).

##### How to install python libaries?
...
##### Steps in setting up virtual environments
...
# Migration of code/files/projects to Workbench

### R project migration

There are two methods for migrating codes and associated files / projects from different old IDE's to Workbench

#### Methods in project migration

#### Method A Export and Upload
...
13. Open the Workbench - to be provided on mid-end of October. Select RStudio -\> Start Session to open RStudio IDE.
...
7.  If you are signed into Github, then it will automatically recognize the repositories created by you just as below. Choose the repo you have created above.
...
15. As the project is now on Github, go to Workbench - to be provided on mid-end of October - and pull the project into the new workspace.
16. Open the VS Code.
